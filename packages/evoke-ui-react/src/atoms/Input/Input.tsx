...
const inputVariants = cva(
  ...
  'flex w-full rounded-md border border-input bg-background text-sm shadow-sm transition-all duration-200 ease-out file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 relative z-10',
  {
    variants: {
      size: {
      ...
      state: {
        ...
        error: 'border-destructive bg-destructive/5 hover:border-destructive/80 focus-visible:ring-destructive focus-visible:border-destructive',
        success: 'border-success bg-success/5 hover:border-success/80 focus-visible:ring-success focus-visible:border-success',
        warning: 'border-warning bg-warning/5 hover:border-warning/80 focus-visible:ring-warning focus-visible:border-warning',
    ...
    compoundVariants: [
      ...
      {
        inputType: 'file',
        className: 'file:mr-2 file:px-3 file:py-1 file:rounded-sm file:bg-muted file:text-muted-foreground file:hover:bg-accent file:transition-colors file:cursor-pointer',
      },
      // Search input styling
      {
        inputType: 'search',
        className: '[&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-cancel-button]:w-4 [&::-webkit-search-cancel-button]:h-4 [&::-webkit-search-cancel-button]:bg-muted-foreground [&::-webkit-search-cancel-button]:rounded-full [&::-webkit-search-cancel-button]:cursor-pointer [&::-webkit-search-cancel-button]:hover:bg-destructive',
      },
      ...
      {
        state: 'default',
        className: 'focus:placeholder:opacity-50 focus:placeholder:transform focus:placeholder:translate-y-[-1px]',
      },
    ],
    defaultVariants: {
      size: 'md',
